/* Library Management System You are going to build a project based on Library Management System. It keeps track of all information about books in the library, their cost, status and total number of books available in the library.

Create a database named library and following TABLES in the database: 1. Branch 2. Employee 3. Books 4. Customer 5. IssueStatus 6. ReturnStatus and insert 10 rows into respective 6 tables 
...
Values
(201, 'Alice Johnson', 'Librarian', 40000.00, 1),
(202, 'Bob Smith', 'Assistant Librarian', 550000.00, 1),
(203, 'Carol Davis', 'Librarian', 52000.00, 2),
(204, 'David Martin', 'Library Technician', 35000.00, 2),
(205, 'Eva Brown', 'Librarian', 55000.00, 3),
(206, 'Frank Wilson', 'Library Assistant', 53000.00, 3),
...
(210, 'Jack Miller', 'Assistant Librarian', 55000.00, 5),
...
Values
('978-3-16-148410-0', 'The Great Gatsby', 'Fiction', 35.00, 'Yes', 'F. Scott Fitzgerald', 'Scribner'),
...
('978-0-452-28423-4', 'Pride and Prejudice', 'Romance', 44.00, 'No', 'Jane Austen', 'T. Egerton'),
...
('978-0-14-044926-6', 'War and Peace', 'Historical', 27.00, 'No', 'Leo Tolstoy', 'The Russian Messenger'),
('978-0-307-27560-9', 'The Da Vinci Code', 'Thriller', 35.50, 'Yes', 'Dan Brown', 'Doubleday'),
...
(8, 'Frank Black', '505 Walnut Drive, Springfield, IL 62708', '2020-08-30'),
...
VALUES
(1, 1, 'The Great Gatsby', '2018-06-01', '978-3-16-148410-0'),
...
(6, 6, 'To Kill a Mockingbird', '2020-11-20', '978-0-14-017739-8'),
(7, 7, 'Pride and Prejudice', '2023-12-05', '978-0-452-28423-4'),
(8, 8, 'Jane Eyre', '2024-01-10', '978-0-452-28425-8'),
(9, 9, 'The history of the Peloponnesian War', '2019-02-15', '978-0-14-044926-6'),
...
Select Category, count(*) AS Total_Counts from books group by category;
...
FROM IssueStatus I
JOIN Books B ON I.Isbn_book = B.ISBN JOIN Customer C ON I.Issued_cust = C.Customer_Id
